...
import { ArrowBack as ArrowBackIcon, AddShoppingCart as ShoppingCartIcon } from '@mui/icons-material';
  ...
  return (
    <AppBar position="static" sx={{ marginBottom: '2rem' }}>
      <Toolbar>
        <Box sx={{ flexGrow: 1 }}>
          {showBackButton && (
            <IconButton edge="start" color="inherit" aria-label="Voltar" onClick={handleBackButtonClick}>
              <ArrowBackIcon />
            </IconButton>
          )}
        </Box>
        <IconButton color="inherit" onClick={() => router.push('/carrinho')}>
